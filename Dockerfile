...
# Needed for the Transcode step (ADR-0012): Ubuntu Noble's ffmpeg package ships libsvtav1, so
# no separate PPA or from-source build is required to get an AV1 encoder.
RUN apt-get update \
